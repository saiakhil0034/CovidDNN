...
class PEPX(nn.Module):
    def __init__(self, ni, no):
        ...
        self.model = nn.Sequential(
            ...
            nn.Conv2d(n2, n2, 3, 1, 1, bias=False, groups=n2),
            nn.BatchNorm2d(n2),
            nn.ReLU(inplace=True),
...
class CovidDNN(nn.Module):
    ...
    def __init__(self):
        ...
        self.convp_1 = nn.Conv2d(64, 64, kernel_size=1,
                               stride=2, padding=0, bias=False)
        self.pepx1_1 = PEPX(64, 256)
        self.pepx1_2 = PEPX(256 * 2, 256)
        self.pepx1_3 = PEPX(256 * 3, 256)
        
        self.convp_2 = nn.Conv2d(256*4, 256*4, kernel_size=1,
                               stride=2, padding=0, bias=False)
        ...
        self.convp_3 = nn.Conv2d(512 * 5, 512 * 5, kernel_size=1,
                               stride=2, padding=0, bias=False)
        ...
        self.convp_4 = nn.Conv2d(1024 * 7, 1024 * 7, kernel_size=1,
                               stride=2, padding=0, bias=False)
        ...
        self.fc = nn.Sequential(nn.Linear(2048*7*7, 1024),
    ...
    def forward(self, input):
        ...
        y1_d = self.convp_1(y1)
        y1_1 = self.pepx1_1(y1_d)
        ...
        y_conv_2 = self.conv2(y_conv_1f)
        
        y2_d = self.convp_2(y1_3f)
        y2_1 = self.pepx2_1(y2_d)
        ...
        y3_d = self.convp_3(y2_4f)
        y3_1 = self.pepx3_1(y3_d)
        ...
        y4_d = self.convp_4(y3_6f)
        y4_1 = self.pepx4_1(y4_d)
        ...
        #print(y_conv_5.shape)
        y_f = y_conv_5.view(y_conv_5.shape[0], -1)
